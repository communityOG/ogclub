...
export default function Footer() {
  return (
    <div className='bg-[#010101] px-40 pt-16 pb-10 font-Progress flex flex-col items-center gap-12'>
        <h3 className=' text-center text-4xl'>Ready to join the ranks of the OGs? Membership is by application only, 'cause we're all about quality, not quantity</h3>
        <button className='mt-2  hover:scale-110  duration-300 ease-in-out  text-xl p-1.5 px-3.5 drop-shadow-xl shadow-xl bg-[#FA0300] w-fit btn-pop'>JOIN THE NFT WAITLIST</button>
