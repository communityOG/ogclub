...
export default function Mission() {
  return (
    <div className='md:bg-homeMission md:min-h-[542px] my-8 '>
        <div className='bg-gradient-to-t from-black/80 to-transparent md:min-h-[542px] flex justify-end items-end pb-12 px-9 md:pb-12 md:px-24'>
