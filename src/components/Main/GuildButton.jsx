...
export default function GuildButton(props) {
  ...
  return (
    <div className='flex w-52  md:w-auto relative group items-center hover:scale-105 duration-300 ease-in-out btn-pop gap-2 drop-shadow-xl shadow-xl p-2 border border-[#707070] bg-black/50 rounded-lg w-fit'>
        <div>
