...
import OGmain from "@/images/ogmain.png"
  ...
  return (
    <div className='h-screen bg-cover bg-no-repeat bg-center w-screen bg-main relative'>
        ...
        <div className='absolute top-[50%] flex justify-center w-full '>
          <Link href="Home" className='hover:scale-110  duration-300 ease-in-out font-Progress text-2xl p-1.5 px-3.5 drop-shadow-xl shadow-xl bg-[#FA0300] btn-pop'>EXPERIENCE THE OG WORLD</Link>
        </div>
